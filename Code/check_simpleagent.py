...
def main():
    ...
    label=data['label']
    case=data['case']
    azure = Azure('8b5d3473-35ad-428d-aadb-b3b2598e308d',
                  '2m4kf1Yy7v8QdijcUUlwV63bH6ov16iDwdn0O8PWzfYiFJngU2d+YZkULdubph+AF17O2qvFUnDO4r2fyIbV1A==',
    ...
    for i in tqdm(range(0,len(case))):
        ...
        print(res)
        ans.append(res)
        pd.DataFrame({"case":ques,"res":ans}).to_excel('./res_ontsingleagent.xlsx')
